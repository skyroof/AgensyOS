...
def generate_fallback_report(
    ...
    return f"""<b>1. ОБЩЕЕ ВПЕЧАТЛЕНИЕ</b>
Кандидат уровня {level}. 
На основе анализа ответов набрано {total}/100 баллов.

<b>2. СИЛЬНЫЕ СТОРОНЫ</b>
{insights_text}
...
<b>4. HARD SKILLS</b>
Оценка: {scores['hard_skills']}/30.
Технические навыки соответствуют уровню {level}.

<b>5. SOFT SKILLS</b>
Оценка: {scores['soft_skills']}/25.
Коммуникация и лидерские качества требуют внимания.

<b>6. МЫШЛЕНИЕ</b>
Оценка: {scores['thinking']}/25.
Системное мышление проявлено на уровне ответов.

<b>7. MINDSET</b>
Оценка: {scores['mindset']}/20.
Мотивация и ценности кандидата.

<b>8. РЕКОМЕНДАЦИИ ПО РАЗВИТИЮ</b>
1. Углубить технические знания в слабых зонах.
2. Развивать навыки коммуникации и презентации решений.
3. Фокусироваться на бизнес-результатах.

<b>9. ИТОГОВЫЙ ВЕРДИКТ</b>
Уровень: {level}.
Рекомендуется составить детальный план развития (PDP).

<i>Примечание: Это автоматический отчёт (AI временно недоступен).</i>"""
