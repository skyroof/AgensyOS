...
<i>Подписка на задания и базу знаний</i>
...
async def show_pack_details(callback: CallbackQuery, state: FSMContext):
    ...
    details = {
        "single": {
            ...
            "price": "299 ₽",
            "desc": """
✅ <b>Полный анализ компетенций</b>
• 10 глубоких вопросов
• Оценка 12 метрик (Hard, Soft, Thinking, Mindset)
• Сравнение с рынком (Junior/Middle/Senior)

📄 <b>PDF-отчёт (15+ страниц):</b>
• Детальный разбор каждого ответа
• Ваши сильные стороны и зоны роста
• Персональный план развития (PDP) на 30 дней

<i>Идеально, чтобы узнать свой текущий уровень.</i>
"""
        },
        "pack3": {
            ...
            "discount": "22%",
            "desc": """
✅ <b>Всё, что в одной диагностике, но 3 раза.</b>

📉 <b>Зачем это нужно?</b>
• Пройди сейчас → получи план развития
• Через месяц → замерь прогресс
• Через 3 месяца → подтверди рост грейда

💡 <i>Экономия 198 ₽. Лучший выбор для роста.</i>
"""
        },
        "pack10": {
...
• Для регулярного трекинга (раз в 2 недели)
• Можно использовать для оценки команды
• Максимальная выгода

💡 <i>Экономия 1000 ₽. Цена одной диагностики < 200 ₽.</i>
"""
        },
        "subscription_1m": {
            ...
            "price": "199 ₽",
            "desc": """
🔄 <b>Система непрерывного развития.</b>

📅 <b>Еженедельно:</b>
• 1 микро-задание из твоего PDP
• Полезные материалы под твои зоны роста
• Чек-ины прогресса

🧠 <b>База знаний:</b>
• Доступ к библиотеке лучших ответов
• Шаблоны для работы (Frameworks)

<i>Преврати развитие в привычку.</i>
"""
        }
    }
